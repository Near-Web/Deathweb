...
/obj/item/clothing/under/rank/migrant
	...
	update_icon(var/mob/living/carbon/human/user)
		...
		if(user?.gender == FEMALE)
			...
			migover	= icon("icon" = 'icons/mob/uniform_f.dmi', "icon_state" = "migover_s")
		else if(FAT in user?.mutations)
			mob = new/icon("icon" = 'icons/mob/uniform_fat.dmi', "icon_state" = "migrant_s")
			migover	= icon("icon" = 'icons/mob/uniform_fat.dmi', "icon_state" = "migover_s")
		else
			mob = new/icon("icon" = 'icons/mob/uniform.dmi', "icon_state" = "migrant_s")
			migover	= icon("icon" = 'icons/mob/uniform.dmi', "icon_state" = "migover_s")
