...
/obj/item/clothing/shoes/lw/jackboots/triton
	name = "Gate jackboots"
	desc = "Characteristic boots worn by all members of the Enoch's Gate garrison."
	icon_state = "triton"
	item_state = "triton"
	armor = list(melee = 15, bullet = 0)
	item_worth = 15
...
/obj/item/clothing/shoes/lw/nobelshoes
	name = "noble boots"
	icon_state = "nobelshoes"
	item_state = "nobelshoes"
	armor = list(melee = 20, bullet = 0)
	item_worth = 24
	siemens_coefficient = 0.7
	armor_type = ARMOR_LEATHER
	body_parts_covered = FEET
