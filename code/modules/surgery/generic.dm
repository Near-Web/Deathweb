...
/datum/surgery_step/teeth
	...
	can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if((!istype(I, /obj/item/stack/teeth/human/golden)) && (!istype(I, /obj/item/stack/teeth/human)))
			return 0
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if((!istype(I, /obj/item/stack/teeth/human/golden)) && (!istype(I, /obj/item/stack/teeth/human)))
			return
		var/obj/item/stack/teeth/human/T = I
		var/amt = (U.max_teeth) - (U.get_teeth())
		var/obj/item/stack/teeth/human/T2 = new /obj/item/stack/teeth/human(U)
