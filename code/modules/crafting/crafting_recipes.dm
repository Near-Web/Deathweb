...
/datum/craft_recipe/items/canningcrate
	name = "Canning Crate"
	id = "canningcrate"
	skillRequired = SKILL_CRAFT
	skill_value = 1
	materials = list(/obj/item/stack/sheet/wood = 1)
	desc_materials = "1 shroomwood logs"
	path_type = /obj/item/canningcrate
	max_count = 3
	nostructure = FALSE
...
/datum/craft_recipe/other/woodbundle
	name = "Wood Bundle"
	id = "woodbundle"
	skillRequired = SKILL_SMITH
	skill_value = 1
	materials = list(/obj/item/stack/sheet/wood = 6)
	desc_materials = "6 shroomwood logs"
	path_type = /obj/item/ore/lw/woodbundle
	nostructure = FALSE
...
/datum/craft_recipe/cult/xom
	name = "Xom"
	id = "xom"
	cult_type = "Old Ways"
	skillRequired = SKILL_CRAFT
	skill_value = 3
	materials = list(/obj/item/stone = 5, /obj/item/reagent_containers/food/snacks/organ/heart = 1, /obj/item/reagent_containers/food/snacks/organ/brain = 1, /obj/item/reagent_containers/food/snacks/organ/internal/penis = 1)
	desc_materials = "5 stone and one of all Masters of men."
	path_type = /obj/structure/oldways/xom
