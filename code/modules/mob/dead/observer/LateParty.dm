...
/proc/check_late_party()
	if(latepartied_list.len >= LATEPARTY_MAX)
		...
		switch(whatLateParty)
			...
			if("soulbreaker")
				possiblefates = list("Bashar1", "Soulbreaker1", "Soulbreaker1", "Eunuch1", "Soulbreaker1", "Soulbreaker1")
			if("countess")
		...
		while(candidatos.len)
			...
			switch(chosen)
				if("Father1")
					...
					to_chat(new_character, "<span class='objectivesbig'>You're migrating to Enoch's Gate.</span>")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #1: Duel my brother at Enoch's Gate and give my wife a LESSON.</span>")
				...
				if("Wife1")
					...
					new_character.real_name  = random_name(new_character.gender)
					new_character.name = new_character.real_name
					to_chat(new_character, "<span class='objectivesbig'>You're migrating to Enoch's Gate with your husband.</span>")
				...
				if("Heir1")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #1: Support my father on Enoch's Gate.</span>")
					new_character.h_style = random_hair_style(gender = new_character.gender, species = "Human")
		...
		// SOULBREAKER
				if("Bashar1")
					...
					var/obj/item/device/radio/R = new /obj/item/device/radio/headset/bracelet/soulbreaker(new_character)
			...
			// COUNTESS
				if("Countess1")
					...
					var/obj/item/device/radio/R = new /obj/item/device/radio/headset/syndicate(new_character)
					R.set_frequency(SYND_FREQ)
				...
				if("Counthandgift")
					...
					to_chat(new_character, "<span class='objectives'>Lead your squad to Enoch's Gate and deliver the gift!</span>")
					...
					for(var/obj/effect/landmark/L in landmarks_list)
						if (L.name == "Countgift")
							new_character.forceMove(L.loc)
					to_chat(world, "<br>")
					to_chat(world, "<h1 class='ravenheartfortress'>Enoch's Gate Fortress</h1>")
					...
					for(var/obj/machinery/charon/C in world)
						...
						NG.info = "<h2>The count sent a group to Enoch's Gate to deliver us a gift!</h2>"
				...
				if("SirVandenberg")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #2:</span> <span class='objectives'>Seek refuge in Enoch's Gate.</span>")
				...
				if("LadyVandenberg")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #1:</span> <span class='objectives'>Seek refuge in Enoch's Gate.</span>")
				...
				if("Cerberus")
					...
					for(var/obj/effect/landmark/L in landmarks_list)
						if (L.name == "migstart")
							new_character.forceMove(L.loc)
					hasrolled = TRUE
					to_chat(new_character, "<span class='objectivesbig'> You're a Cerberus, what remains of the Cerberii of Ravenheart after its fall.</span>")
					to_chat(new_character, "<span class='objectives'> Get to Enoch's Gate fortress and rest your weary legs.</span>")
				...
				if("Inquisitor1")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #2:</span> <span class='objectives'>Seek out what remains of heretical activity in Enoch's Gate.</span>")
				...
				if("Practicus1")
					...
					to_chat(new_character, "<span class='baronboldoutlined'>Objective #1:</span> <span class='objectives'>Seek out what remains of heretical activity in Enoch's Gate.</span>")
