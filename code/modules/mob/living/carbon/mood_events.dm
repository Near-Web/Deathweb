...
/datum/happiness_event/cursed
	description = "<span class='badmood'>• I've been cursed!</span>\n"
	happiness = -6
	timeout = 800
...
/datum/happiness_event/hunter
	description = "<span class='goodmood'>•</span> <span class='passivebold'> I know the truth.</span>\n"
	happiness = 10
	timeout = INFINITY
...
/datum/happiness_event/misc/vicardead
	description = "<span class='badmood'>• Our Vicar is dead, who will save our souls?!</span>\n"
	happiness = -3
...
//FINE
/datum/happiness_event/misc/smallfine
	description = "<span class='badmood'>• Damn, I need to pay this fine.</span>\n"
	happiness = -4

/datum/happiness_event/misc/medfine
	description = "<span class='badmood'>• Fnord! That's a big fine!</span>\n"
	happiness = -8

/datum/happiness_event/misc/largefine
	description = "<span class='badmood'>• My life is over! How am I ever gonna pay that fine?!</span>\n"
	happiness = -16
...
/datum/happiness_event/vice/dirty_soul
	description = "<span class='badmood'>• I have absorbed too many sins, and must repent.</span>\n"
	happiness = -20
