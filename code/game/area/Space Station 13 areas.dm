...
/area/dunwell/station/bridge/noble/throne_room
	...
	RoomDesc = "The Great Hall towers before you, forked banners with embellished trimmings covering its walls. Between each banner stands a tall candle, lit to illuminate the mosaics of past conquerors and victors before them. The Throne of The Gate sits high above the rest, its sovereign seated below the many-limbed cephalopod Visage, said to contain the spirits of its most esteemed rulers."
...
/area/shuttle //DO NOT TURN THE ul_Lighting STUFF ON FOR SHUTTLES. IT BREAKS THINGS.
	...
	has_gravity = 1
	hum = 1 //Lets see if this fixes things
