...
/obj/item/card/id/syndicate/attack_self(mob/user as mob)
	if(!src.registered_name)
		...
		var t = sanitize_name(input(user, "What name would you like to put on this card?", "Agent card name", ishuman(user) ? user.real_name : user.name), MAX_NAME_LEN, TRUE, TRUE)
