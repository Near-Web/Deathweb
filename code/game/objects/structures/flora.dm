...
/obj/structure/lifeweb/mushroom/makus
	name = "Markus shroom"
	icon = 'icons/mining.dmi'
	icon_state = "markus"
	var/inicializado = 0
...
/obj/structure/lifeweb/mushroom/makus/glow/New()
	..()
	lumosoviks_list += src

/obj/structure/lifeweb/mushroom/makus/process()
	if(ticker.current_state == GAME_STATE_PLAYING && src.inicializado != TRUE)
		set_light(3, 3, 2.8, 1, "#5ef03c")
		inicializado = TRUE
		processing_objects.Remove(src)
