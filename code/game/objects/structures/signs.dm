...
/obj/structure/sign/signnew/web/tnc
	name = "\improper Tri-Net Corporation"
	icon_state = "NT"
...
/obj/structure/sign/signnew/web/walllargeenoch
	name = "Enoch's Gate Banner"
	icon_state = "walllarge1"

/obj/structure/sign/signnew/web/wallsmallenoch
	name = "Enoch's Gate Banner"
	icon_state = "wallsmall1"
