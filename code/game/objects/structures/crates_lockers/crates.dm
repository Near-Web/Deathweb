...
/obj/structure/closet/crate/bin1
    name = "bin"
    desc = "A rusty old bin bucket."
    icon = 'icons/obj/storage.dmi'
    icon_state = "bin"
    icon_opened = "binopen"
    icon_closed = "bin"

/obj/structure/closet/crate/blackbox
    name = "BLACKBOX"
    desc = "A glowing white console of sorts."
    icon = 'icons/obj/storage.dmi'
    icon_state = "blackbox"
    icon_opened = "blackbox"
    icon_closed = "blackbox"
