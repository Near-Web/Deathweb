...
/datum/controller/processScheduler
	...
	var/list/tmp/datum/controller/process/processes = new

	// Processes that are currently running
	var/list/tmp/datum/controller/process/running = new

	// Processes that are idle
	var/list/tmp/datum/controller/process/idle = new

	// Processes that are queued to run
	var/list/tmp/datum/controller/process/queued = new

	// Process name -> process object map
	var/list/tmp/datum/controller/process/nameToProcessMap = new

	// Process last queued times (world time)
	var/list/tmp/datum/controller/process/last_queued = new

	// Process last start times (real time)
	var/list/tmp/datum/controller/process/last_start = new

	// Process last run durations
	var/list/tmp/datum/controller/process/last_run_time = new

	// Per process list of the last 20 durations
	var/list/tmp/datum/controller/process/last_twenty_run_times = new

	// Process highest run time
	var/list/tmp/datum/controller/process/highest_run_time = new
